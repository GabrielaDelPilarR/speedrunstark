...
mod Staker {
    ...
    impl StakerImpl of IStaker<ContractState> {
        ...
        fn withdraw(ref self: ContractState) { // Todo in UI: Staker contract should approve to transfer back the sender_amount to the sender
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn _not_completed(ref self: ContractState) {
            assert(!self.completed(),'Action already complete');
        }
    }
}
